...
<title>Locale Store Inventory</title>
  ...
  */
  ...
  <!--<![endif]-->
    ...
    <spring:url value="/resources/core/css/pivot.css" var="pivotCss" />
    <link href="${pivotCss}" rel="stylesheet" />

    <spring:url value="/resources/core/js/pivot.js" var="pivotJs" />
...
<form name="delete-form" class="form-inline" method="POST" action="${url}">
  ...
  $(function(){
      $("#output").pivotUI($("#collections-table"),
      {
          rows: ["Locale", "PHILNONI Juice"],
          cols: [""]
      });
   });
  </script>
